...
console.log("Reading voicebank directory...");
const vbFiles = fs.readdirSync(voicebankDir);
console.log(`Found ${vbFiles.length} files.`);
...
console.log("Saved voicebanks_catalog.json");
...
console.log("Updating singer profile pages in src/public/singers/ ...");
...
if (fs.existsSync(rootSingersDir)) {
  console.log("Updating singer profile pages in Singer Profile/singers/ ...");
...
console.log("All singer profiles updated successfully!");
